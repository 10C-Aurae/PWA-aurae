...
const ARQUETIPOS = [
  { nombre: 'Techie',         afinidades: new Set(['tecnologia', 'innovacion', 'gaming']),         emoji: '⚡', desc: 'Explorador de lo digital y lo nuevo' },
  { nombre: 'Creativo',       afinidades: new Set(['arte', 'musica', 'sustentabilidad']),           emoji: '🎨', desc: 'Tu mirada transforma el espacio' },
  { nombre: 'Networker',      afinidades: new Set(['networking', 'negocios', 'innovacion']),        emoji: '🤝', desc: 'Conectas personas e ideas' },
  { nombre: 'Gourmet',        afinidades: new Set(['gastronomia', 'sustentabilidad', 'arte']),      emoji: '🍽️', desc: 'Vives para experiencias con sabor' },
  { nombre: 'Atleta',         afinidades: new Set(['deportes', 'sustentabilidad']),                 emoji: '🏃', desc: 'Energía en movimiento' },
  { nombre: 'Estratega',      afinidades: new Set(['negocios', 'gaming', 'networking']),            emoji: '♟️', desc: 'Siempre tres pasos adelante' },
  { nombre: 'Eco-consciente', afinidades: new Set(['sustentabilidad', 'gastronomia', 'deportes']), emoji: '🌿', desc: 'El mundo importa, y lo cuidas' },
  { nombre: 'Artista',        afinidades: new Set(['arte', 'musica', 'gastronomia']),               emoji: '🎭', desc: 'Sientes, creas, inspiras' },
